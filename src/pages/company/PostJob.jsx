...
export default function PostJob() {
  ...
  const validateForm = () => {
    ...
    } else if (formData.jobType.length > 50) {
      newErrors.jobType = "Job type cannot exceed 50 characters.";
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await companyJobService.createJob(payload);
      ...
      // Handle unauthorized/company not approved
      else if (err.response?.status === 401) {
        setServerError("Your company account is not approved yet. Please wait for admin approval.");
      }
      // Handle generic error
      else {
        setServerError("Failed to create job posting. Please try again.");
      }
        ...
        <div style={{ marginBottom: 32 }}>
          ...
          <div>
            ...
            <p className="helper" style={{ fontSize: 16 }}>
              Fill in the details below to create a new job posting. Required fields are marked with <span style={{ color: "var(--coral)" }}>*</span>
            </p>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ display: "grid", gap: 24 }}>
              ...
              <div>
                ...
                <div className="helper" style={{ marginTop: 4 }}>
                  Provide a detailed description of the position, including daily tasks and team structure.
                </div>
              </div>
              ...
              <div>
                ...
                <div className="helper" style={{ marginTop: 4 }}>
                  List required skills, qualifications, education, and experience. Use bullet points for clarity.
                </div>
              </div>
              ...
              <div>
                ...
                />
                <div className="helper" style={{ marginTop: 4 }}>
                  Describe key responsibilities and day-to-day tasks (optional but recommended).
                </div>
              </div>
