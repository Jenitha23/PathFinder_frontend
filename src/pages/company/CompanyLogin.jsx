...
export default function CompanyLogin() {
  ...
  return (
    <div
      className="auth-page auth-login-page"
      style={{
      ...
      >
        ...
        >
          ...
          >
            Welcome back.
            <br />
            <span style={{ color: "#2EC4B6" }}>Manage hiring</span>
            <br />
            in one place.
          </h2>
          <p
          ...
          >
            Sign in to publish opportunities, review applicants, and coordinate your recruitment workflow.
          </p>

          <div style={{ display: "grid", gap: 16 }}>
            {[
              { icon: "PO", text: "Post internship and job opportunities faster" },
              { icon: "AR", text: "Review and manage applicant pipelines" },
              { icon: "TM", text: "Track hiring activity across your team" },
            ].map((feature) => (
              <div key={feature.text} style={{ display: "flex", alignItems: "center", gap: 14 }}>
                ...
                <p style={{ color: "rgba(255,255,255,0.75)", fontSize: 14, lineHeight: 1.5 }}>{feature.text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ width: "100%", maxWidth: 400 }} className="auth-form-shell animate-fade-up">
          <div style={{ marginBottom: 36 }}>
            ...
            <p className="helper" style={{ fontSize: 15 }}>
              Sign in to your PathFinder company account.
            </p>
          </div>
          ...
          <p style={{ textAlign: "center", fontSize: 13, color: "var(--muted)", marginTop: 24 }}>
            Are you a student?{" "}
            <Link to="/student/login" style={{ color: "var(--primary)" }}>
              Student login
            </Link>
          </p>
        </div>
